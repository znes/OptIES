...
from data_fw import import_data, import_timeseries, create_pypsa_network
...
buses, buses_fw, lines, generators, storage_units, stores, links, links_fw, loads = import_data(
    args['path']
)

el_profiles, th_profiles, gas_profile, pv = import_timeseries(args['path']+'timeseries/')
