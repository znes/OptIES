...
Neben den beschriebenen Skripten werden Daten für die Durchführung von Optimierungsrechnungen des vorliegenden Systems benötigt. Die Inputdatensätze sind auf *zenodo* (DOI `10.5281/zenodo.10784800`_) veröffentlicht. Diese Datensätze enthalten einerseits reale Messdaten und andererseits synthetisch generierte Daten.
